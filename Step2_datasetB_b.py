...
#Speicherort der Daten aus Step 1
folder_name = 'Daten aus Step 1/GitHub Data Rest/'
...
year_list = year_list[2:] # ohne 2011 und 2017
...
resultDF.to_pickle('DataFrameOutput_pull_comments_rest.pkl') # Speichern des Data Frames http://pandas.pydata.org/pandas-docs/stable/io.html#io-pickle
