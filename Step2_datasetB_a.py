...
folder_name = 'Daten aus Step 1/GitHubData/'
...
year_list = year_list[2:] # 2013 bis 2017
...
resultDF.to_pickle('DataFrameOutput_pull_comments_PC.pkl') # Speichern des Data Frames http://pandas.pydata.org/pandas-docs/stable/io.html#io-pickle
