...
for year in list(months_for_year.keys()):
#for year in [2016]:
        ...
        for day in range(month_length[month]):
            ...
            for hour in hour_range:
                ...
                with gzip.open(local_filename, 'rb') as f: #https://docs.python.org/2/library/gzip.html
                    file_content = f.read()
                tmp_data_after = set(os.listdir('C:\\Users\\Benedikt\\AppData\\Local\\Temp'))
...
#                    einigermassen robust.
                    os.remove('C:\\Users\\Benedikt\\AppData\\Local\\Temp\\{}'.format(new_temp_file)) #https://docs.python.org/2/library/os.html
                except:
